...
RSpec.describe '/events', type: :request do
  ...
  let(:valid_attributes) do
    { event_points: 1, event_description: 'test', event_passcode: 'test', event_start: Date.today,
      event_end: Date.today, event_title: 'test', event_location: 'test' }
  end

  let(:invalid_attributes) do
    { event_points: nil, event_description: nil, event_passcode: nil, event_start: nil, event_end: nil,
      event_title: nil, event_location: nil }
  end
