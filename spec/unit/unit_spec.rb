...
RSpec.describe User, type: :model do
  subject do
    described_class.new(first_name: 'John', last_name: 'Doe', email: 'johndoe@gmail.com', password: '123',
                        point: 0, is_admin: false)
  end
...
RSpec.describe User, type: :model do
  subject do
    described_class.new(first_name: 'John', last_name: 'Doe', email: 'johndoe@gmail.com', password: '123', point: 0,
                        is_admin: false)
  end
