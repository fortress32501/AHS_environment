...
Event.create!([
  {
    ...
    event_passcode: 'password',
    event_start: '2022-10-07 16:22:00',
    event_end: '2022-10-07 16:22:00',
    event_title: 'Event 1',
    event_location: 'Zoom',
    event_type_id: '1'
  },
  {
    ...
    event_passcode: 'password2',
    event_start: '2022-10-08 16:23:00',
    event_end: '2022-10-08 16:23:00',
    event_title: 'Event 2',
    event_location: 'Zoom',
    event_type_id: ''
  }
...
User.create!([
  {
    ...
    password_digest: '$2a$12$7wDlUndiAVVpEMSStsZkA./R8PMWYE3okaP7gVJkSXI00vdslmQZG',
    point: 0,
    is_admin: true,
    ranking_id: nil
  }
...
User.create!([
  { first_name: 'Pear', last_name: 'Ratano', email: 'pear@gmail.com', password: '123', point: 0, is_admin: true, ranking_id: nil }
]
            )