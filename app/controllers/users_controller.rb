      ...
      respond_to do |format|
        format.html do
          redirect_to(accounts_path,
                      notice: 'You do not have access to show other users. You can request Administrator Access through Administrator request page.'
                     )
        end
  ...
  def index
    ...
    unless current_user.is_admin
      respond_to do |format|
        format.html do
          redirect_to(accounts_path,
                      notice: 'You do not have access to see other users. You can request Administrator Access through Administrator request page.'
                     )
        end
        format.json { head(:no_content) }
      end
  ...
  def destroy
    respond_to do |format|
      if current_user.is_admin
        ...
        format.html do
          redirect_to(accounts_path,
                      notice: 'You do not have access to destroy other users. You can request Administrator Access through Administrator request page.'
                     )
        end
        format.json { head(:no_content) }
      end
