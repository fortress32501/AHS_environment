...
class AdminRequestsController < ApplicationController
  ...
  def new
      ...
      respond_to do |format|
        format.html do
          redirect_to admin_requests_path,
                      notice: 'You do not have access to create requests. You are already an admin.'
        end
        format.json { head :no_content }
      end
    ...
    if @has_request
      respond_to do |format|
        format.html do
          redirect_to admin_requests_path,
                      notice: 'You do not have access to create requests. You can only have one in progress at a time.'
        end
        format.json { head :no_content }
      end
  ...
  def edit
    ...
    if @admin_request.request_status != 'REQUESTED'
      respond_to do |format|
        format.html do
          redirect_to admin_requests_path, notice: 'You can only edit requests that are currently REQUESTED.'
        end
        format.json { head :no_content }
      end
  ...
  def approve
    ...
    unless current_user.is_admin
      respond_to do |format|
        format.html do
          redirect_to admin_requests_path, notice: 'You do not have access to approve requests. You are not an admin.'
        end
        format.json { head :no_content }
      end
    ...
    if @admin_request.request_status != 'REQUESTED'
      respond_to do |format|
        format.html do
          redirect_to admin_requests_path,
                      notice: 'You do not have access to approve that request. It has already been processed.'
        end
        format.json { head :no_content }
      end
  ...
  def deny
    ...
    unless current_user.is_admin
      respond_to do |format|
        format.html do
          redirect_to admin_requests_path, notice: 'You do not have access to deny requests. You are not an admin.'
        end
        format.json { head :no_content }
      end
    ...
    if @admin_request.request_status != 'REQUESTED'
      respond_to do |format|
        format.html do
          redirect_to admin_requests_path,
                      notice: 'You do not have access to deny that request. It has already been processed.'
        end
        format.json { head :no_content }
      end
  ...
  def create
    ...
    if @has_request
      respond_to do |format|
        format.html do
          redirect_to admin_requests_path,
                      notice: 'You do not have access to create more requests. You are currently have a request in progress.'
        end
        format.json { head :no_content }
      end
  ...
  def has_admin_request
    ...
    @has_request = AdminRequest.all.select do |req|
